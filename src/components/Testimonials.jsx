  ...
  return (
    <div className="flex gap-0.5">
      {Array.from({ length: count }).map((_, i) => (
        <svg key={i} className="h-3.5 w-3.5 text-terracotta" fill="currentColor" viewBox="0 0 20 20">
    ...
    <section id="reviews" className="bg-burgundy/5 py-20 sm:py-28">
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <div className="mb-14 text-center">
          <span className="text-xs tracking-[0.3em] text-sage uppercase">Love Letters</span>
          ...
          {reviews.map((review) => (
            ...
            >
              ...
              <footer className="mt-6 border-t border-cream-dark pt-5">
                ...
                <p className="text-xs text-muted">{review.location} · {review.product}</p>
              </footer>
            </blockquote>
          ))}
        </div>
